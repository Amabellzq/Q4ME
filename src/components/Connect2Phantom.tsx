...
const Connect2Phantom: FC = () => {
    ...
    return (
        <div>
            { walletAvail ?
                <>
                <button id="ConnectPhantom" className= "btn btn-primary" disabled={connected} onClick={connectHandler}>Pay with Phantom</button>
                <button id="DisablePhantom" className= "btn btn-primary" disabled={!connected} onClick={disconnectHandler}>Disconnect from Phantom</button>
